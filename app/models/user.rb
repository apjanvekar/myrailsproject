...
validates_presence_of  :USR_UserName,  :on => :create, :message =>"^Enter the User Name"

validates_presence_of  :USR_UserName,  :on => :update, :message =>"^Enter the User Name"
#validates_presence_of  :password,  :on => :update

  #validates_presence_of :login, :USR_GroupID,  :on => :create, :message =>"^Enter the Group Name"
  #validates_presence_of :login, :USR_GroupID, :on => :update, :message =>"^Enter the Group Name"
